  ...
  render() {
    return (
      <div className=" home-page text-center ">
        <div className="d-flex pt-4 sm-row justify-content-center container">
          ...
          <section className="ml-4">
            ...
            <div className="transforming-button">
              <NavLink className="nav-link" to="/">Coming Soon...</NavLink>
            </div>
          </section>
        </div>
        <div className="mt-4 blurb-container">
          <h1>What is an Ironman?</h1>
          <p>
            The idea behind an Ironman is to test each player's ability to play a variety of characters.
          </p>
          <p>
            Online, the rules are simply that you must play as every single character in the game without losing once, <br/> with optional lenient rules being that you don't have to restart after a loss. <br/>
